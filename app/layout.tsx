...
function Menu() {
  return (
    <div className="m-auto flex justify-center text-center md:hidden fixed bottom-3 left-1/2 -translate-x-1/2 w-2/3 h-fit py-3 rounded-full gap-5 text-3xl bg-white shadow-2xl z-1">
